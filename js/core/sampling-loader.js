...
async function loadSamplingMethods() {
    try {
        ...
        const basePath = chrome.runtime.getURL('js/statistical_sampling/');
        ...
        await loadScript(basePath + 'isolation_forest.js');
        ...
        if (window.SamplingMethods &&
            ...
            console.warn('Не все методы выборки доступны после загрузки скриптов');
